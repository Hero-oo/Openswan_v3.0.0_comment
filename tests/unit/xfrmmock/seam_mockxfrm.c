...
static ipsec_spi_t mock_spis[4] = { 0x12345678, 0x34567812, 0x56781234,
				    0x78123456 };
static int mock_spinext = 0;
/* spis, spinext is in seam_kernel.c */
ipsec_spi_t mock_get_spi(const ip_address *src, const ip_address *dst,
...
bool unit_do_command(struct connection *c, const struct spd_route *sr,
