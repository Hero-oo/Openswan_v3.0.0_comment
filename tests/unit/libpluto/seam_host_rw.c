...
struct iface_dev rw_ifd1 = { .id_count = 1,
			     .id_vname = "ipsec0",
			     .id_rname = "eth0" };

struct iface_port rw_if1 = { .ip_dev = &rw_ifd1,
			     .port = 500,
...
{
	rw_if1.ip_addr.u.v4.sin_addr.s_addr =
		htonl(0x5db8d822); /* 93.184.216.34 example.com */
