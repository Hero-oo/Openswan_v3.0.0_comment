...
struct iface_dev dave_ifd1 = { .id_count = 1,
			       .id_vname = "ipsec0",
			       .id_rname = "eth0" };

struct iface_port dave_if1 = { .ip_dev = &dave_ifd1,
			       .port = 500,
...
void init_dave_interface(void)
{
	...
	dave_if1.ip_addr.u.v4.sin_addr.s_addr =
		htonl(0x5db8d823); /* 93.184.216.35 example.com */
	interfaces = &dave_if1;
}
#endif
