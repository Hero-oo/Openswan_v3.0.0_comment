...
struct iface_dev vzhost_ifd1 = { .id_count = 1,
				 .id_vname = "ipsec0",
				 .id_rname = "eth0" };
...
struct iface_port vzhost_if1 = {
	...
	.ip_addr.u.v4.sin_addr.s_addr =
		0xADE68547, /* 173.230.133.71 -- see htonl() below */
	.fd = -1,
	.next = NULL,
	.ike_float = 0,
	.change = IFN_KEEP
...
{
	vzhost_if1.ip_addr.u.v4.sin_addr.s_addr =
		htonl(vzhost_if1.ip_addr.u.v4.sin_addr.s_addr);
