struct iface_dev sun_ifd1 = { .id_count = 1,
			      .id_vname = "ipsec0",
			      .id_rname = "eth0" };

struct iface_port sun_if1 = { .ip_dev = &sun_ifd1,
			      .port = 500,
...
struct iface_port sun_if2 = { .ip_dev = &sun_ifd1,
			      .port = 4500,
			      .socktypename = "AF_INET",
			      .ip_addr.u.v4.sin_family = AF_INET,
			      .fd = -1,
...
void init_sun_interface(bool doipv6 UNUSED)
{
	char *virtual_private =
		"%v4:10.0.0.0/8,%v4:192.168.0.0/16,%v4:172.16.0.0/12,%v4:25.0.0.0/8,%v6:fd00::/8,%v6:fe80::/10";
