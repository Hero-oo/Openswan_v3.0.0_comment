...
int main(int argc, char *argv[])
{
	...
	alg_info_ike = alg_info_ike_create_from_str(argv[1], &err);
...
struct artab {
	...
	enum ikev2_trans_type_encr encr_id;
	unsigned int eklen;
...
} atodatatab[] = {
	{
		...
		"3des(3)-hmac_md5_96(1)-prfmd5(1)-MODP1024(2); flags=-strict",
		FALSE,
	},
	{
	...
	},
	{
		...
		IKEv2_PRF_HMAC_MD5,
		OAKLEY_GROUP_MODP1024,
		"aes_cbc(12)_128-hmac_md5_96(1)-prfmd5(1)-MODP1024(2); flags=-strict",
		FALSE,
	},
	{
		"aes-sha1-modp1024",
		...
		IKEv2_PRF_HMAC_SHA1,
		OAKLEY_GROUP_MODP1024,
		"aes_cbc(12)_128-hmac_sha1_96(2)-prfsha1(2)-MODP1024(2); flags=-strict",
		FALSE,
	},
	{
		"aes-sha1-modp1536",
		...
		"aes_cbc(12)_128-hmac_sha1_96(2)-prfsha1(2)-MODP1536(5); flags=-strict",
		FALSE,
	},
	...
	/* from DTP ikev1/alg-sha512 */
	{
		...
		"aes_cbc(12)_256-hmac_sha2_512_256(14)-prfsha2_512(7)-MODP4096(16); flags=-strict",
		FALSE,
	},
	...
	/* a modern definition from draft-ietf-ipsecme-rfc7321bis/ */
	{
		...
		"aes_cbc(12)_256-hmac_sha2_256_128(12)-prfsha2_256(5)-MODP2048(14); flags=-strict",
		FALSE,
	},
	{
		NULL,
	...
	regress(pgm) char *pgm;
{
	...
	for (r = atodatatab; r->ascii != NULL; r++) {
		err = NULL;
		alg_info_ike = alg_info_ike_create_from_str(r->ascii, &err);
		if (r->err && err != NULL) {
		...
		if (alg_info_ike->ike[0].ike_eklen != r->eklen) {
			fprintf(stderr,
				...
				"  got:              %d\n",
				r->ascii, (int)r->eklen,
				(int)alg_info_ike->ike[0].ike_eklen);
		}
