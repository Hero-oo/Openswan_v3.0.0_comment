...
#define IP_SEND(skb, dev) ip_send(skb);
...
static inline struct ipsecpriv *
netdev_to_ipsecpriv(const struct net_device *dev)
{
...
extern int osw_ipv6_find_hdr(const struct sk_buff *skb, unsigned int *offset,
