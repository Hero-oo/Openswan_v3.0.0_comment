...
extern struct connection
	*cur_connection; /* current connection, for diagnostics */
...
extern bool whack_prompt_for(int whackfd, const char *prompt1,
			     const char *prompt2, bool echo, char *ansbuf,
			     size_t ansbuf_len);
...
#define GLOBALS_ARE_RESET()                              \
	(whack_log_fd == NULL_FD && cur_state == NULL && \
	 cur_connection == NULL && cur_from == NULL &&   \
