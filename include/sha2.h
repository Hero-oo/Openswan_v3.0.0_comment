...
extern void sha256_hash_buffer(const unsigned char *, int, unsigned char *,
			       int);
...
extern void sha512_hash_buffer(const unsigned char *, int, unsigned char *,
			       int);
...
extern void sha384_hash_buffer(const unsigned char *, int, unsigned char *,
			       int);
#endif /* _SHA2_H */
