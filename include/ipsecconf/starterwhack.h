...
extern int
starter_whack_build_pkmsg(struct starter_config *cfg, struct whack_message *msg,
			  struct starter_conn *conn, struct starter_end *end,
			  unsigned int keynum, enum pubkey_source key_type,
