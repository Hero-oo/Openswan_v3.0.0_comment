...
static MP_INT modp1024_modulus, modp1536_modulus, modp2048_modulus,
	modp3072_modulus, modp4096_modulus, modp6144_modulus, modp8192_modulus;

static MP_INT dh22_modulus, dh23_modulus, dh24_modulus;

MP_INT groupgenerator; /* MODP group generator (2) */

MP_INT generator_dh22, generator_dh23, generator_dh24;

const struct oakley_group_desc unset_group = { 0, NULL, NULL,
					       0 }; /* magic signifier */
...
const struct oakley_group_desc oakley_group[] = {
	...
	{ OAKLEY_GROUP_MODP8192, &groupgenerator, &modp8192_modulus,
	  BYTES_FOR_BITS(8192) },
	{ OAKLEY_GROUP_DH22, &generator_dh22, &dh22_modulus,
	  BYTES_FOR_BITS(1024) },
	{ OAKLEY_GROUP_DH23, &generator_dh23, &dh23_modulus,
	  BYTES_FOR_BITS(2048) },
	{ OAKLEY_GROUP_DH24, &generator_dh24, &dh24_modulus,
	  BYTES_FOR_BITS(2048) },
...
bool ike_alg_register_group(enum ikev2_trans_type_dh modpid,
			    ...
			    const MP_INT *generator, const MP_INT *modulus)
{
...
void init_crypto_groups(void)
{
	...
	ike_alg_register_group(OAKLEY_GROUP_MODP1024, &groupgenerator,
			       &modp1024_modulus);
	ike_alg_register_group(OAKLEY_GROUP_MODP1536, &groupgenerator,
			       &modp1536_modulus);
	ike_alg_register_group(OAKLEY_GROUP_MODP2048, &groupgenerator,
			       &modp2048_modulus);
	ike_alg_register_group(OAKLEY_GROUP_MODP3072, &groupgenerator,
			       &modp3072_modulus);
	ike_alg_register_group(OAKLEY_GROUP_MODP4096, &groupgenerator,
			       &modp4096_modulus);
	ike_alg_register_group(OAKLEY_GROUP_MODP6144, &groupgenerator,
			       &modp6144_modulus);
	ike_alg_register_group(OAKLEY_GROUP_MODP8192, &groupgenerator,
			       &modp8192_modulus);

	ike_alg_register_group(OAKLEY_GROUP_DH22, &generator_dh22,
			       &dh22_modulus);
	ike_alg_register_group(OAKLEY_GROUP_DH23, &generator_dh23,
			       &dh23_modulus);
	ike_alg_register_group(OAKLEY_GROUP_DH24, &generator_dh24,
			       &dh24_modulus);
}
