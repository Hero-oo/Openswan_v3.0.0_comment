...
static const u_int32_t sha256_hashInit[8] = { 0x6a09e667, 0xbb67ae85,
...
static void sha256_transform(sha256_context *ctx, const unsigned char *datap)
{
	...
	j = 0;
	do {
		W[j] = (((u_int32_t)(datap[0])) << 24) |
		       (((u_int32_t)(datap[1])) << 16) |
...
void sha256_hash_buffer(const unsigned char *ib, int ile, unsigned char *ob,
			int ole)
{
	sha256_context ctx;
...
static void sha512_transform(sha512_context *ctx, const unsigned char *datap)
{
	...
	j = 0;
	do {
		W[j] = (((u_int64_t)(datap[0])) << 56) |
		       (((u_int64_t)(datap[1])) << 48) |
		       (((u_int64_t)(datap[2])) << 40) |
		       (((u_int64_t)(datap[3])) << 32) |
		       (((u_int64_t)(datap[4])) << 24) |
		       (((u_int64_t)(datap[5])) << 16) |
...
void sha512_hash_buffer(const unsigned char *ib, int ile, unsigned char *ob,
			int ole)
{
	sha512_context ctx;
...
void sha384_hash_buffer(const unsigned char *ib, int ile, unsigned char *ob,
			int ole)
{
	sha512_context ctx;
