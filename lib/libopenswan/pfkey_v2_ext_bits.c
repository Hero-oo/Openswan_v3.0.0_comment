...
pfkey_ext_track extensions_bitmaps[2 /*in/out*/][2 /*perm/req*/][K_SADB_MAX +
	...
	/* INBOUND EXTENSIONS */
	{
		...
		{ /* K_SADB_RESERVED */
		  0,
		  /* SADB_GETSPI */
		  1ULL << SADB_EXT_RESERVED | 1ULL << SADB_EXT_ADDRESS_SRC |
			  1ULL << SADB_EXT_ADDRESS_DST |
			  1ULL << SADB_EXT_ADDRESS_PROXY |
			  1ULL << SADB_EXT_SPIRANGE,
		  /* SADB_UPDATE */
		  1ULL << SADB_EXT_RESERVED | 1ULL << SADB_EXT_SA |
		  ...
		  1ULL << SADB_EXT_RESERVED | 1ULL << SADB_EXT_SA |
			  ...
			  1ULL << K_SADB_X_EXT_PROTOCOL,
		  /* SADB_X_DEBUG */
		  1ULL << SADB_EXT_RESERVED | 1ULL << K_SADB_X_EXT_DEBUG,
		  ...
		  1ULL << SADB_EXT_RESERVED | 1ULL << SADB_EXT_SA |
			  ...
			  1ULL << K_SADB_X_EXT_NAT_T_DPORT,
		  /* SADB_X_PLUMBIF */
		  1ULL << SADB_EXT_RESERVED | 1ULL << K_SADB_X_EXT_PLUMBIF,
		  /* SADB_X_UNPLUMBIF */
		  1ULL << SADB_EXT_RESERVED | 1ULL << K_SADB_X_EXT_PLUMBIF },
		...
		{ /* K_SADB_RESERVED */
		  0,
		  /* K_SADB_GETSPI */
		  1ULL << K_SADB_EXT_RESERVED | 1ULL << K_SADB_EXT_ADDRESS_SRC |
			  1ULL << K_SADB_EXT_ADDRESS_DST |
			  1ULL << K_SADB_EXT_SPIRANGE,
		  /* K_SADB_UPDATE */
		  1ULL << K_SADB_EXT_RESERVED | 1ULL << K_SADB_EXT_SA |
	...
	/* OUTBOUND EXTENSIONS */
	{
		...
		{ /* K_SADB_RESERVED */
		  ...
		  1ULL << SADB_EXT_RESERVED | 1ULL << SADB_EXT_ADDRESS_SRC |
			  ...
			  1ULL << SADB_EXT_PROPOSAL,
		  /* SADB_REGISTER */
		  1ULL << SADB_EXT_RESERVED | 1ULL << SADB_EXT_SUPPORTED_AUTH |
			  1ULL << SADB_EXT_SUPPORTED_ENCRYPT,
		  /* SADB_EXPIRE */
		  1ULL << SADB_EXT_RESERVED | 1ULL << SADB_EXT_SA |
			  1ULL << SADB_EXT_LIFETIME_CURRENT |
...

{
	...
	if ((extensions_seen & req) != req) {
		ERROR("extensions for op: %d seen: %08llx required %08llx, missing: %08llx\n",
		      sadb_operation, (unsigned long long)extensions_seen,
