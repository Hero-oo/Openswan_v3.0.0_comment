...
void pfkey_print(struct sadb_msg *msg, FILE *out)
{
	...
	fprintf(out,
		...
		msg->sadb_msg_version, msg->sadb_msg_type, msg->sadb_msg_errno,
		msg->sadb_msg_satype, msg->sadb_msg_len, (int)msg->sadb_msg_seq,
	...
	while (len > sizeof(struct sadb_ext)) {
		...
		case SADB_EXT_SA: {
			...
			fprintf(out,
				...
				(int)sa->sadb_sa_spi, sa->sadb_sa_replay,
				sa->sadb_sa_state, sa->sadb_sa_auth,
				sa->sadb_sa_encrypt, (int)sa->sadb_sa_flags,
