...
size_t /* true length (with NUL) for success */
	datatot(src, srclen, format, dst, dstlen) const unsigned char *src;
size_t srclen;
 ...
 */
static void convert(src, nreal, format, out) const char *src;
 ...
 */
size_t /* true length (with NUL) for success */
	datatoa(src, srclen, format, dst, dstlen) const unsigned char *src;
size_t srclen;
int format; /* character indicating what format */
char *dst; /* need not be valid if dstlen is 0 */
size_t dstlen;
 ...
 */
size_t /* true length (with NUL) for success */
	bytestoa(src, srclen, format, dst, dstlen) const unsigned char *src;
size_t srclen;
int format; /* character indicating what format */
char *dst; /* need not be valid if dstlen is 0 */
size_t dstlen;
