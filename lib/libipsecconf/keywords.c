...
static const struct keyword_enum_value kt_values[] = {
	KEV_LITERAL(kt_string),	    KEV_LITERAL(kt_appendstring),
	KEV_LITERAL(kt_appendlist), KEV_LITERAL(kt_filename),
	KEV_LITERAL(kt_dirname),    KEV_LITERAL(kt_bool),
	KEV_LITERAL(kt_invertbool), KEV_LITERAL(kt_enum),
	KEV_LITERAL(kt_list),	    KEV_LITERAL(kt_loose_enum),
	KEV_LITERAL(kt_rsakey),	    KEV_LITERAL(kt_number),
	KEV_LITERAL(kt_time),	    KEV_LITERAL(kt_percent),
	KEV_LITERAL(kt_ipaddr),	    KEV_LITERAL(kt_subnet),
	KEV_LITERAL(kt_idtype),	    KEV_LITERAL(kt_bitstring),
	KEV_LITERAL(kt_comment),
};
static const struct keyword_enum_values kt_values_list =
	VALUES_INITIALIZER(kt_values);
#endif
...
static const struct keyword_enum_values kw_failureshunt_list =
	VALUES_INITIALIZER(kw_failureshunt_values);

/*
 * Values for keyexchange=
 */
static const struct keyword_enum_value kw_keyexchange_values[] = {
	{ "ike", KE_IKE },	{ "ikev1", KE_IKEv1 }, { "isakmp", KE_IKEv1 },
	{ "oakley", KE_IKEv1 }, { "ikev2", KE_IKEv2 }, { "rfc7296", KE_IKEv2 },
};

static const struct keyword_enum_values kw_keyexchange_list =
	VALUES_INITIALIZER(kw_keyexchange_values);

/*
 * Values for Four-State options, such as ikev2
 */
static const struct keyword_enum_value kw_fourvalued_values[] = {
	{ "never", fo_never },	   { "permit", fo_permit },
	{ "propose", fo_propose }, { "insist", fo_insist },
	{ "yes", fo_propose },	   { "always", fo_insist },
	{ "no", fo_never }
};

static const struct keyword_enum_values kw_fourvalued_list =
	VALUES_INITIALIZER(kw_fourvalued_values);
...
static const struct keyword_enum_values kw_authby_list =
	VALUES_INITIALIZER(kw_authby_values);
...
struct keyword_enum_values kw_dpdaction_list = {
	kw_dpdaction_values,
	sizeof(kw_dpdaction_values) / sizeof(struct keyword_enum_value)
};
...
static const struct keyword_enum_value kw_auto_values[] = {
	{ "ignore", STARTUP_NO },   { "add", STARTUP_ADD },
	{ "route", STARTUP_ROUTE }, { "start", STARTUP_START },
	{ "up", STARTUP_START }, /* alias */
};

static const struct keyword_enum_values kw_auto_list =
	VALUES_INITIALIZER(kw_auto_values);

/*
 * Values for connaddrfamily={ipv4,ipv6}
 */
static const struct keyword_enum_value kw_connaddrfamily_values[] = {
	{ "ipv4", AF_INET },  { "v4", AF_INET },  { "inet", AF_INET },
	{ "ipv6", AF_INET6 }, { "v6", AF_INET6 }, { "inet6", AF_INET6 },
};

const struct keyword_enum_values kw_connaddrfamily_list =
	VALUES_INITIALIZER(kw_connaddrfamily_values);

/*
 * Values for type={tunnel,transport,udpencap}
 */
static const struct keyword_enum_value kw_type_values[] = {
	{ "tunnel", KS_TUNNEL },    { "transport", KS_TRANSPORT },
	{ "udp", KS_UDPENCAP },	    { "udpencap", KS_UDPENCAP },
	{ "pass", KS_PASSTHROUGH }, { "passthrough", KS_PASSTHROUGH },
	{ "reject", KS_REJECT },    { "drop", KS_DROP },
};

static const struct keyword_enum_values kw_type_list =
	VALUES_INITIALIZER(kw_type_values);
...
static const struct keyword_enum_values kw_rsasigkey_list =
	VALUES_INITIALIZER(kw_rsasigkey_values);

/*
 * Values for protostack={klips, none, auto, klipsmast, netkey }
 */
static const struct keyword_enum_value kw_proto_stack_list[] = {
	{ "none", NO_KERNEL },	    { "auto", AUTO_PICK },
	{ "klips", USE_KLIPS },	    { "mast", USE_MASTKLIPS },
	{ "netkey", USE_NETKEY },   { "native", USE_NETKEY },
	{ "bsd", USE_BSDKAME },	    { "kame", USE_BSDKAME },
	{ "bsdkame", USE_BSDKAME }, { "win2k", USE_WIN2K },
};

static const struct keyword_enum_values kw_proto_stack =
	VALUES_INITIALIZER(kw_proto_stack_list);
...
static const struct keyword_enum_values kw_sareftrack_list =
	VALUES_INITIALIZER(kw_sareftrack_values);
...
static const struct keyword_enum_values kw_remote_peer_type =
	VALUES_INITIALIZER(kw_remote_peer_type_list);
...
struct keyword_enum_values kw_plutodebug_list = {
	...
	sizeof(kw_plutodebug_values) / sizeof(struct keyword_enum_value)
};
...
struct keyword_enum_values kw_klipsdebug_list = {
	kw_klipsdebug_values,
	sizeof(kw_klipsdebug_values) / sizeof(struct keyword_enum_value)
};
...
static const struct keyword_enum_values kw_phase2types_list =
	VALUES_INITIALIZER(kw_phase2types_values);
...
static const struct keyword_enum_value kw_sendcert_values[] = {
	{ "never", cert_neversend },	   { "sendifasked", cert_sendifasked },
	{ "alwayssend", cert_alwayssend }, { "always", cert_alwayssend },
	{ "forcedtype", cert_forcedtype },
};

struct keyword_enum_values kw_sendcert_list = {
	kw_sendcert_values,
	sizeof(kw_sendcert_values) / sizeof(struct keyword_enum_value)
};
...
struct keyword_def ipsec_conf_keywords_v2[] = {
	...
	{ "plutostderrlog", kv_config, kt_filename, KSF_PLUTOSTDERRLOG,
	  NOT_ENUM },
	{ "plutostderrlogtime", kv_config, kt_bool, KBF_PLUTOSTDERRLOGTIME,
	  NOT_ENUM },
	...
	{ "disable_port_floating", kv_config, kt_bool, KBF_DISABLEPORTFLOATING,
	  NOT_ENUM },
	{ "keep_alive", kv_config, kt_number, KBF_KEEPALIVE, NOT_ENUM },
	{ "force_keepalive", kv_config, kt_bool, KBF_FORCE_KEEPALIVE,
	  NOT_ENUM },
	...
	{ "forwardcontrol", kv_config | kv_obsolete, kt_string, KBF_WARNIGNORE,
	  NOT_ENUM },
	{ "rp_filter", kv_config | kv_obsolete, kt_string, KBF_WARNIGNORE,
	  NOT_ENUM },

	/* this is "left=" and "right=" */
	{ "", kv_conn | kv_leftright, kt_loose_enumarg, KSCF_IP, &kw_host_list,
	  LOOSE_ENUM_OTHER, '/' },

	{ "ike", kv_conn | kv_auto, kt_string, KSF_IKE, NOT_ENUM },

	{ "subnet", kv_conn | kv_auto | kv_leftright | kv_processed, kt_subnet,
	  KSCF_SUBNET, NOT_ENUM },
	...
	{ "nexthop", kv_conn | kv_auto | kv_leftright, kt_ipaddr, KSCF_NEXTHOP,
	  NOT_ENUM },
	{ "firewall", kv_conn | kv_auto | kv_leftright | kv_obsolete, kt_bool,
	  KNCF_FIREWALL, NOT_ENUM },
	{ "updown", kv_conn | kv_auto | kv_leftright, kt_filename, KSCF_UPDOWN,
	  NOT_ENUM },
	{ "id", kv_conn | kv_auto | kv_leftright, kt_idtype, KSCF_ID,
	  NOT_ENUM },
	{ "rsasigkey", kv_conn | kv_auto | kv_leftright, kt_rsakey,
	  KSCF_RSAKEY1, &kw_rsasigkey_list, PUBKEY_PREEXCHANGED },
	{ "rsasigkey2", kv_conn | kv_auto | kv_leftright, kt_rsakey,
	  KSCF_RSAKEY2, &kw_rsasigkey_list, PUBKEY_PREEXCHANGED },
	{ "spibase", kv_conn | kv_auto | kv_leftright, kt_number, KNCF_SPIBASE,
	  NOT_ENUM },
	{ "cert", kv_conn | kv_auto | kv_leftright, kt_filename, KSCF_CERT,
	  NOT_ENUM },
	{ "sendcert", kv_conn | kv_auto | kv_leftright, kt_enum, KNCF_SENDCERT,
	  &kw_sendcert_list },
	{ "ca", kv_conn | kv_auto | kv_leftright, kt_string, KSCF_CA,
	  NOT_ENUM },
	...
	{ "endaddrfamily", kv_conn, kt_enum, KBF_ENDADDRFAMILY,
	  &kw_connaddrfamily_list },
	{ "connaddrfamily", kv_conn, kt_enum, KBF_CLIENTADDRFAMILY,
	  &kw_connaddrfamily_list },
	{ "clientaddrfamily", kv_conn, kt_enum, KBF_CLIENTADDRFAMILY,
	  &kw_connaddrfamily_list },
	{ "tunneladdrfamily", kv_conn, kt_enum, KBF_CLIENTADDRFAMILY,
	  &kw_connaddrfamily_list },
	...
	{ "keyexchange", kv_conn | kv_auto, kt_enum, KBF_KEYEXCHANGE,
	  &kw_keyexchange_list },
	{ "ikev1", kv_conn | kv_auto | kv_processed, kt_bool, KBF_IKEv1,
	  NOT_ENUM },
	{ "ikev2", kv_conn | kv_auto | kv_processed, kt_enum, KBF_IKEv2,
	  &kw_fourvalued_list },
	{ "narrowing", kv_conn | kv_auto, kt_bool, KBF_IKEv2_ALLOW_NARROWING,
	  NOT_ENUM },
	...
	{ "sha2_truncbug", kv_conn | kv_auto, kt_bool, KBF_SHA2_TRUNCBUG,
	  NOT_ENUM },
	{ "keylife", kv_conn | kv_auto | kv_alias, kt_time, KBF_SALIFETIME,
	  NOT_ENUM },
	{ "lifetime", kv_conn | kv_auto | kv_alias, kt_time, KBF_SALIFETIME,
	  NOT_ENUM },
	...
	{ "labeled_ipsec", kv_conn | kv_auto, kt_bool, KBF_LABELED_IPSEC,
	  NOT_ENUM },
	{ "policy_label", kv_conn | kv_auto, kt_string, KSF_POLICY_LABEL,
	  NOT_ENUM },
	...
	{ "phase2alg", kv_conn | kv_auto | kv_manual, kt_string, KSF_ESP,
	  NOT_ENUM },
	{ "esp", kv_conn | kv_auto | kv_manual | kv_alias, kt_string, KSF_ESP,
	  NOT_ENUM },
	{ "ah", kv_conn | kv_auto | kv_manual | kv_alias, kt_string, KSF_ESP,
	  NOT_ENUM },
	{ "subnetwithin", kv_conn | kv_leftright, kt_string, KSCF_SUBNETWITHIN,
	  NOT_ENUM },
	{ "protoport", kv_conn | kv_leftright | kv_processed, kt_string,
	  KSCF_PROTOPORT, NOT_ENUM },
	{ "phase2", kv_conn | kv_auto | kv_manual | kv_policy, kt_enum,
	  KBF_PHASE2, &kw_phase2types_list },
	{ "auth", kv_conn | kv_auto | kv_manual | kv_policy | kv_alias, kt_enum,
	  KBF_PHASE2, &kw_phase2types_list },
	...
	{ "firstmsgid", kv_conn | kv_auto, kt_number, KBF_FIRSTMSGID,
	  NOT_ENUM },
	...
	{ "aggrmode", kv_conn | kv_auto, kt_invertbool, KBF_AGGRMODE,
	  NOT_ENUM },
	{ "aggressive", kv_conn | kv_auto, kt_invertbool, KBF_AGGRMODE,
	  NOT_ENUM },
	...
	{ "modecfgpull", kv_conn | kv_auto, kt_invertbool, KBF_MODECONFIGPULL,
	  NOT_ENUM },
	{ "modecfgdns1", kv_conn | kv_auto | kv_leftright, kt_ipaddr,
	  KSCF_MODECFGDNS1, NOT_ENUM },
	{ "modecfgdns2", kv_conn | kv_auto | kv_leftright, kt_ipaddr,
	  KSCF_MODECFGDNS2, NOT_ENUM },
	{ "modecfgwins1", kv_conn | kv_auto | kv_leftright, kt_ipaddr,
	  KSCF_MODECFGWINS1, NOT_ENUM },
	{ "modecfgwins2", kv_conn | kv_auto | kv_leftright, kt_ipaddr,
	  KSCF_MODECFGWINS2, NOT_ENUM },
	/* things for manual keying only */
	{ "spi", kv_conn | kv_leftright | kv_manual, kt_number, KNCF_SPI,
	  NOT_ENUM },
	{ "espenckey", kv_conn | kv_leftright | kv_manual, kt_bitstring,
	  KSCF_ESPENCKEY, NOT_ENUM },
	{ "espauthkey", kv_conn | kv_leftright | kv_manual, kt_bitstring,
	  KSCF_ESPAUTHKEY, NOT_ENUM },
	{ "espreplay_window", kv_conn | kv_leftright | kv_manual, kt_number,
	  KNCF_ESPREPLAYWINDOW, NOT_ENUM },

	/* some things from libreswan, which we will probably accept */
	{ "plutofork", kv_config | kv_obsolete, kt_bool, KBF_PLUTOFORK,
	  NOT_ENUM },
...
struct keyword_def ipsec_conf_keyword_comment = { "x-comment", kv_conn,
						  kt_comment, 0, NOT_ENUM };

const int ipsec_conf_keywords_v2_count =
	sizeof(ipsec_conf_keywords_v2) / sizeof(struct keyword_def);
...
unsigned int parser_loose_enum_arg(struct keyword *k, const char *s,
				   char **rest)
{
	...
	assert(kd->type == kt_loose_enum || kd->type == kt_loose_enumarg ||
	       kd->type == kt_rsakey);
	...
	for (kevcount = kd->validenum->valuesize, kev = kd->validenum->values;
	     kevcount > 0 && strcasecmp(s, kev->name) != 0; kev++, kevcount--)
		;
