...
struct parser_context {
	...
	char prfalg_buf[16];
	char modp_buf[16];
	enum ikev2_trans_type_encr (*ealg_getbyname)(const char *const str,
						     int len,
						     unsigned int *auxp);
	enum ikev2_trans_type_integ (*aalg_getbyname)(const char *const str,
						      int len,
						      unsigned int *auxp);
	enum ikev2_trans_type_prf (*prfalg_getbyname)(const char *const str,
						      int len,
						      unsigned int *auxp);
	enum ikev2_trans_type_dh (*modp_getbyname)(const char *const str,
						   int len, unsigned int *auxp);
	char *ealg_str;
	char *aalg_str;
	char *prfalg_str;
	char *modp_str;
...
extern enum ikev2_trans_type_encr ealg_getbyname(const char *const str, int len,
						 unsigned int *auxp);
extern enum ikev2_trans_type_integ aalg_getbyname(const char *const str,
						  int len, unsigned int *auxp);
extern enum ikev2_trans_type_dh modp_getbyname(const char *const str, int len,
					       unsigned int *auxp);
