...
#define VID_SUBSTRING \
	(VID_SUBSTRING_DUMPHEXA | VID_SUBSTRING_DUMPASCII | VID_SUBSTRING_MATCH)
...
#define DEC_MD5_VID(id, str) { VID_##id, VID_MD5HASH, str, NULL, NULL, 0 },
...
static struct vid_struct _vid_tab[] = {
	...
	*/
	...
	DEC_MD5_VID(SSH_SENTINEL, "SSH Sentinel") DEC_MD5_VID(
		SSH_SENTINEL_1_1, "SSH Sentinel 1.1")
		DEC_MD5_VID(SSH_SENTINEL_1_2, "SSH Sentinel 1.2") DEC_MD5_VID(
			SSH_SENTINEL_1_3, "SSH Sentinel 1.3")
			DEC_MD5_VID(SSH_SENTINEL_1_4, "SSH Sentinel 1.4")
				DEC_MD5_VID(SSH_SENTINEL_1_4_1,
					    "SSH Sentinel 1.4.1")

	/* These ones come from SSH vendors.txt */
	DEC_MD5_VID(SSH_IPSEC_1_1_0, "Ssh Communications Security IPSEC Express version 1.1.0") DEC_MD5_VID(
		SSH_IPSEC_1_1_1,
		"Ssh Communications Security IPSEC Express version 1.1.1") DEC_MD5_VID(SSH_IPSEC_1_1_2,
										       "Ssh Communications Security IPSEC Express version 1.1.2")
		DEC_MD5_VID(SSH_IPSEC_1_2_1, "Ssh Communications Security IPSEC Express version 1.2.1") DEC_MD5_VID(
			SSH_IPSEC_1_2_2,
			"Ssh Communications Security IPSEC Express version 1.2.2")
			DEC_MD5_VID(SSH_IPSEC_2_0_0, "SSH Communications Security IPSEC Express version 2.0.0") DEC_MD5_VID(
				SSH_IPSEC_2_1_0,
				"SSH Communications Security IPSEC Express version 2.1.0")
				DEC_MD5_VID(SSH_IPSEC_2_1_1, "SSH Communications Security IPSEC Express version 2.1.1") DEC_MD5_VID(
					SSH_IPSEC_2_1_2,
	 ...
	 */
	{ VID_TIMESTEP, VID_STRING | VID_SUBSTRING_DUMPASCII, "TIMESTEP", NULL,
	  NULL, 0 },
	...
	DEC_MD5_VID(NATT_STENBERG_01, "draft-stenberg-ipsec-nat-traversal-01")
		DEC_MD5_VID(NATT_STENBERG_02,
			    "draft-stenberg-ipsec-nat-traversal-02")
			DEC_MD5_VID(NATT_HUTTUNEN, "ESPThruNAT") DEC_MD5_VID(
				NATT_HUTTUNEN_ESPINUDP,
				"draft-huttunen-ipsec-esp-in-udp-00.txt")
				DEC_MD5_VID(NATT_IETF_00,
	...
	DEC_MD5_VID_D(
		NATT_IETF_02_N, "draft-ietf-ipsec-nat-t-ike-02\n",
		"draft-ietf-ipsec-nat-t-ike-02_n") DEC_MD5_VID(NATT_IETF_03,
							       "draft-ietf-ipsec-nat-t-ike-03")
		DEC_MD5_VID(NATT_IETF_04, "draft-ietf-ipsec-nat-t-ike-04") DEC_MD5_VID(
			NATT_IETF_05, "draft-ietf-ipsec-nat-t-ike-05")
			DEC_MD5_VID(NATT_IETF_06,
				    "draft-ietf-ipsec-nat-t-ike-06")
				DEC_MD5_VID(NATT_IETF_07,
					    "draft-ietf-ipsec-nat-t-ike-07")
					DEC_MD5_VID(
						NATT_IETF_08,
						"draft-ietf-ipsec-nat-t-ike-08")
						DEC_MD5_VID(
							NATT_DRAFT_IETF_IPSEC_NAT_T_IKE,
							"draft-ietf-ipsec-nat-t-ike")
							DEC_MD5_VID(NATT_RFC,
								    "RFC 3947")
	 ...
	 * strongSwan
	 */
	DEC_MD5_VID(STRONGSWAN_4_0_0, "strongSwan 4.0.0") DEC_MD5_VID(STRONGSWAN_4_0_1, "strongSwan 4.0.1") DEC_MD5_VID(
		STRONGSWAN_4_0_2,
		"strongSwan 4.0.2") DEC_MD5_VID(STRONGSWAN_4_0_3,
						"strongSwan 4.0.3") DEC_MD5_VID(STRONGSWAN_4_0_4,
										"strongSwan 4.0.4") DEC_MD5_VID(STRONGSWAN_4_0_5,
														"strongSwan 4.0.5") DEC_MD5_VID(STRONGSWAN_4_0_6, "strongSwan 4.0.6")
		DEC_MD5_VID(STRONGSWAN_4_0_7, "strongSwan 4.0.7") DEC_MD5_VID(STRONGSWAN_4_1_0, "strongSwan 4.1.0") DEC_MD5_VID(STRONGSWAN_4_1_1, "strongSwan 4.1.1") DEC_MD5_VID(
			STRONGSWAN_4_1_2,
			"strongSwan 4.1.2") DEC_MD5_VID(STRONGSWAN_4_1_3, "strongSwan 4.1.3")
			DEC_MD5_VID(STRONGSWAN_4_1_4, "strongSwan 4.1.4") DEC_MD5_VID(STRONGSWAN_4_1_5, "strongSwan 4.1.5") DEC_MD5_VID(STRONGSWAN_4_1_6, "strongSwan 4.1.6") DEC_MD5_VID(
				STRONGSWAN_4_1_7,
				"strongSwan 4.1.7") DEC_MD5_VID(STRONGSWAN_4_1_8, "strongSwan 4.1.8")
				DEC_MD5_VID(STRONGSWAN_4_1_9, "strongSwan 4.1.9") DEC_MD5_VID(STRONGSWAN_4_1_10, "strongSwan 4.1.10") DEC_MD5_VID(
					STRONGSWAN_4_1_11,
					"strongSwan 4.1.11") DEC_MD5_VID(STRONGSWAN_4_2_0,
									 "strongSwan 4.2.0") DEC_MD5_VID(STRONGSWAN_4_2_1,
													 "strongSwan 4.2.1") DEC_MD5_VID(STRONGSWAN_4_2_2,
																	 "strongSwan 4.2.2") DEC_MD5_VID(STRONGSWAN_4_2_3,
																					 "strongSwan 4.2.3")

					DEC_MD5_VID(STRONGSWAN_2_8_8, "strongSwan 2.8.8") DEC_MD5_VID(STRONGSWAN_2_8_7, "strongSwan 2.8.7") DEC_MD5_VID(
						STRONGSWAN_2_8_6,
						"strongSwan 2.8.6") DEC_MD5_VID(STRONGSWAN_2_8_5, "strongSwan 2.8.5")
						DEC_MD5_VID(STRONGSWAN_2_8_4, "strongSwan 2.8.4") DEC_MD5_VID(STRONGSWAN_2_8_3, "strongSwan 2.8.3") DEC_MD5_VID(
							STRONGSWAN_2_8_2,
							"strongSwan 2.8.2") DEC_MD5_VID(STRONGSWAN_2_8_1, "strongSwan 2.8.1")
							DEC_MD5_VID(STRONGSWAN_2_8_0, "strongSwan 2.8.0") DEC_MD5_VID(STRONGSWAN_2_7_3, "strongSwan 2.7.3") DEC_MD5_VID(
								STRONGSWAN_2_7_2,
								"strongSwan 2.7.2") DEC_MD5_VID(STRONGSWAN_2_7_1, "strongSwan 2.7.1")
								DEC_MD5_VID(STRONGSWAN_2_7_0, "strongSwan 2.7.0") DEC_MD5_VID(STRONGSWAN_2_6_4, "strongSwan 2.6.4") DEC_MD5_VID(
									STRONGSWAN_2_6_3,
									"strongSwan 2.6.3") DEC_MD5_VID(STRONGSWAN_2_6_2, "strongSwan 2.6.2")
									DEC_MD5_VID(STRONGSWAN_2_6_1, "strongSwan 2.6.1") DEC_MD5_VID(
										STRONGSWAN_2_6_0,
										"strongSwan 2.6.0") DEC_MD5_VID(STRONGSWAN_2_5_7, "strongSwan 2.5.7")
										DEC_MD5_VID(STRONGSWAN_2_5_6, "strongSwan 2.5.6") DEC_MD5_VID(
											STRONGSWAN_2_5_5,
											"strongSwan 2.5.5") DEC_MD5_VID(STRONGSWAN_2_5_4, "strongSwan 2.5.4")
											DEC_MD5_VID(STRONGSWAN_2_5_3, "strongSwan 2.5.3") DEC_MD5_VID(
												STRONGSWAN_2_5_2,
												"strongSwan 2.5.2") DEC_MD5_VID(STRONGSWAN_2_5_1, "strongSwan 2.5.1")
												DEC_MD5_VID(STRONGSWAN_2_5_0, "strongSwan 2.5.0") DEC_MD5_VID(
													STRONGSWAN_2_4_4,
													"strongSwan 2.4.4") DEC_MD5_VID(STRONGSWAN_2_4_3, "strongSwan 2.4.3")
													DEC_MD5_VID(STRONGSWAN_2_4_2, "strongSwan 2.4.2") DEC_MD5_VID(
														STRONGSWAN_2_4_1,
														"strongSwan 2.4.1") DEC_MD5_VID(STRONGSWAN_2_4_0, "strongSwan 2.4.0")
														DEC_MD5_VID(STRONGSWAN_2_3_2, "strongSwan 2.3.2") DEC_MD5_VID(
															STRONGSWAN_2_3_1,
															"strongSwan 2.3.1")
															DEC_MD5_VID(
																STRONGSWAN_2_3_0,
...
const char *init_pluto_vendorid(void)
{
	...
	for (i = 0; i < PLUTO_VENDORID_SIZE; i++) {
		...
		if (pluto_vendorid[i] == 127)
			pluto_vendorid[i] = '_'; /* omit RUBOUT */
	}
	pluto_vendorid[PLUTO_VENDORID_SIZE] = '\0';
	pluto_vendorid_built = TRUE;
...
void init_vendorid(void)
{
	...
	for (vid = _vid_tab; vid->id; vid++) {
		if (vid->flags & VID_SELF) {
			char *d;
			vid->vid = clone_str(init_pluto_vendorid(),
					     "init_pluto_vendorid");
			...
			d = alloc_bytes(
				strlen(vid->descr) + 4 +
					...
					strlen(compile_time_interop_options),
				"self-vendor ID");
			sprintf(d, "%s %s %s", vid->descr, ipsec_version_code(),
			...
			unsigned char *vidm =
				alloc_bytes(MD5_DIGEST_SIZE, "VendorID MD5");
			vid->vid = (char *)vidm;
			if (vidm) {
...
/* We only need these when dealing with XAUTH */
	...
	if (vid->flags & VID_SUBSTRING_DUMPHEXA) {
		...
		for (i = strlen(vid_dump), j = vid->vid_len;
		     (j < len) && (i < sizeof(vid_dump) - 2); i += 2, j++) {
		     ...
		     struct state *st)
{
	...
	for (pvid = _vid_tab; pvid->id; pvid++) {
		if (pvid->vid && vid && pvid->vid_len && len) {
			if (pvid->vid_len == len) {
				...
				if (memcmp(pvid->vid, vid, pvid->vid_len) ==
				    0) {
					handle_known_vendorid(md, vid, len,
							      pvid, st);
					return;
	 ...
	 */
	{
		...
		loglog(RC_LOG_SERIOUS,
		       "ignoring unknown Vendor ID payload [%s%s]", log_vid,
		       (len > MAX_LOG_VID_LEN) ? "..." : "");
	}
}
...
bool out_vendorid(u_int8_t np, pb_stream *outs, unsigned int vid)
{
	...
	return out_generic_raw(np, &isakmp_vendor_id_desc, outs, pvid->vid,
			       pvid->vid_len, "V_ID");
}
