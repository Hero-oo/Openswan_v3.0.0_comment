...
void pluto_crypto_allocchunk(wire_chunk_t *space, wire_chunk_t *new,
			     size_t howbig)
{
	/*
...
void pluto_crypto_copychunk(wire_chunk_t *spacetrack, unsigned char *space,
			    wire_chunk_t *new, chunk_t data)
{
