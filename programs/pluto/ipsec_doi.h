...
extern void ipsecdoi_replace(struct state *st, lset_t policy_add,
			     lset_t policy_del, unsigned long try);

extern void init_phase2_iv(struct state *st, const msgid_t *msgid);

#include "ikev1_quick.h"

extern state_transition_fn main_inI1_outR1, main_inR1_outI2, main_inI2_outR2,
	main_inR2_outI3, main_inI3_outR3, main_inR3, aggr_inI1_outR1_psk,
	aggr_inI1_outR1_rsasig, aggr_inR1_outI2, aggr_inI2;
	...
	{                                                                      \
		...
		if (pbs_left(hash_pbs) != hash_len ||                          \
			...
			loglog(RC_LOG_SERIOUS,                                 \
			       "received " hash_name                           \
			       " does not match computed value in " msg_name); \
...
extern stf_status send_isakmp_notification(struct state *st, u_int16_t type,
