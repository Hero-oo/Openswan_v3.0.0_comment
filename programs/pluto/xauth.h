...
stf_status modecfg_resp(struct state *st, unsigned int resp, pb_stream *s,
			u_int16_t cmd, bool use_modecfg_addr_as_client_addr,
			u_int16_t id);

stf_status xauth_client_resp(struct state *st, unsigned int xauth,
