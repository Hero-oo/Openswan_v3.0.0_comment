...
static bool win2k_raw_eroute(
	...
	unsigned int transport_proto UNUSED, unsigned int esatype UNUSED,
	const struct pfkey_proto_info *proto_info UNUSED,
	time_t use_lifetime UNUSED, unsigned int op UNUSED,
	const char *text_said UNUSED, char *policy_label UNSUSED)
{
	return FALSE;
}
...
static ipsec_spi_t win2k_get_spi(const ip_address *src, const ip_address *dst,
