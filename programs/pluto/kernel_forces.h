...
extern bool netlink_raw_eroute(
...
extern ipsec_spi_t netlink_get_spi(const ip_address *src, const ip_address *dst,
...
extern struct kernel_alg_info *
xfrm_kernel_alg_find(enum ikev2_trans_type alg_type, u_int32_t trans_num);
