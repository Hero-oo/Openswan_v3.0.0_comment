...
@synthesize connName;
//Connection Options
@synthesize selAuto, selType, selMode, selLocalHost, selLocalID,
	selLocalSubnets, selLocalProtocolPort, selRemoteHost, selRemoteID,
	selRemoteSubnets, selRemoteProtocolPort;
//Auth Options
@synthesize selAuthBy, selPSK, selPKCS, selSendCert, selLocalRSASigKey,
	selRemoteRSASigKey;
//Global Options
@synthesize selVirtualPrivate, selForceKeepAlive, selKeepAlive,
	selCrlCheckIntvl, selMyID, selPlutoDebug, selForceEncaps, selNatTEnable,
	selStrictCrlEnable, selOppEncEnable, selUniqueIDs;

//Advanced Options
@synthesize selDPDDelay, selDPDTimeout, selDPDAction, selDPDEnable, selIKE1Enc,
	selIKE1Hash, selIKE2Enc, selIKE2Hash, selIKEv2, selIKELifetime,
	selPhase2, selPhase2Alg, selSALifetime, selRekeyMargin, selRekeyFuzz,
	selKeyingTries, selCompressEnable, selPfsEnable, selRekeyEnable,
	selRemoteXauthUsername, selLocalXauthUsername, selModeCfgDNS1,
	selModeCfgDNS2, selModeCfgWins1, selModeCfgWins2, selLocalXauthServer,
	selLocalXauthClient, selLocalModeCfgServer, selLocalModeCfgClient,
	selRemoteXauthServer, selRemoteXauthClient, selRemoteModeCfgServer,
	selRemoteModeCfgClient, selModeCfgPullEnable, selNHelpers, selSyslog,
	selPlutoOpts, selPlutoStdErrLog, selPlutoRestartOnCrash, selNextHop,
	selSourceIP, selUpdownScript;
...
- (void)encodeWithCoder:(NSCoder *)coder
{
	...
	[coder encodeObject:[self selLocalProtocolPort]
		     forKey:@"selLocalProtocolPort"];
	...
	[coder encodeObject:[self selRemoteProtocolPort]
		     forKey:@"selRemoteProtocolPort"];
	...
	[coder encodeObject:[self selLocalRSASigKey]
		     forKey:@"selLocalRSASigKey"];
	[coder encodeObject:[self selRemoteRSASigKey]
		     forKey:@"selRemoteRSASigKey"];

	//Global Options
	[coder encodeObject:[self selVirtualPrivate]
		     forKey:@"selVirtualPrivate"];
	[coder encodeObject:[self selForceKeepAlive]
		     forKey:@"selForceKeepAlive"];
	...
	[coder encodeObject:[self selStrictCrlEnable]
		     forKey:@"selStrictCrlEnable"];
	...
	[coder encodeObject:[self selCompressEnable]
		     forKey:@"selCompressEnable"];
	[coder encodeObject:[self selPfsEnable] forKey:@"selPfsEnable"];
	[coder encodeObject:[self selRekeyEnable] forKey:@"selRekeyEnable"];

	[coder encodeObject:[self selRemoteXauthUsername]
		     forKey:@"selRemoteXauthUsername"];
	[coder encodeObject:[self selLocalXauthUsername]
		     forKey:@"selLocalXauthUsername"];
	...
	[coder encodeObject:[self selLocalXauthServer]
		     forKey:@"selLocalXauthServer"];
	[coder encodeObject:[self selLocalXauthClient]
		     forKey:@"selLocalXauthClient"];
	[coder encodeObject:[self selLocalModeCfgServer]
		     forKey:@"selLocalModeCfgServer"];
	[coder encodeObject:[self selLocalModeCfgClient]
		     forKey:@"selLocalModeCfgClient"];
	[coder encodeObject:[self selRemoteXauthServer]
		     forKey:@"selRemoteXauthServer"];
	[coder encodeObject:[self selRemoteXauthClient]
		     forKey:@"selRemoteXauthClient"];
	[coder encodeObject:[self selRemoteModeCfgServer]
		     forKey:@"selRemoteModeCfgServer"];
	[coder encodeObject:[self selRemoteModeCfgClient]
		     forKey:@"selRemoteModeCfgClient"];
	[coder encodeObject:[self selModeCfgPullEnable]
		     forKey:@"selModeCfgPullEnable"];
	...
	[coder encodeObject:[self selPlutoStdErrLog]
		     forKey:@"selPlutoStdErrLog"];
	[coder encodeObject:[self selPlutoRestartOnCrash]
		     forKey:@"selPlutoRestartOnCrash"];
...
- (id)initWithCoder:(NSCoder *)coder
{
	...
	[self setSelLocalProtocolPort:
			[coder decodeObjectForKey:@"selLocalProtocolPort"]];
	...
	[self setSelRemoteProtocolPort:
			[coder decodeObjectForKey:@"selRemoteProtocolPort"]];
	...
	[self setSelLocalRSASigKey:
			[coder decodeObjectForKey:@"selLocalRSASigKey"]];
	[self setSelRemoteRSASigKey:
			[coder decodeObjectForKey:@"selRemoteRSASigKey"]];

	//Global Options
	[self setSelVirtualPrivate:
			[coder decodeObjectForKey:@"selVirtualPrivate"]];
	[self setSelForceKeepAlive:
			[coder decodeObjectForKey:@"selForceKeepAlive"]];
	...
	[self setSelStrictCrlEnable:
			[coder decodeObjectForKey:@"selStrictCrlEnable"]];
	...
	[self setSelCompressEnable:
			[coder decodeObjectForKey:@"selCompressEnable"]];
	[self setSelPfsEnable:[coder decodeObjectForKey:@"selPfsEnable"]];
	[self setSelRekeyEnable:[coder decodeObjectForKey:@"selRekeyEnable"]];

	[self setSelRemoteXauthUsername:
			[coder decodeObjectForKey:@"selRemoteXauthUsername"]];
	[self setSelLocalXauthUsername:
			[coder decodeObjectForKey:@"selLocalXauthUsername"]];
	...
	[self setSelLocalXauthServer:
			[coder decodeObjectForKey:@"selLocalXauthServer"]];
	[self setSelLocalXauthClient:
			[coder decodeObjectForKey:@"selLocalXauthClient"]];
	[self setSelLocalModeCfgServer:
			[coder decodeObjectForKey:@"selLocalModeCfgServer"]];
	[self setSelLocalModeCfgClient:
			[coder decodeObjectForKey:@"selLocalModeCfgClient"]];
	[self setSelRemoteXauthServer:
			[coder decodeObjectForKey:@"selRemoteXauthServer"]];
	[self setSelRemoteXauthClient:
			[coder decodeObjectForKey:@"selRemoteXauthClient"]];
	[self setSelRemoteModeCfgServer:
			[coder decodeObjectForKey:@"selRemoteModeCfgServer"]];
	[self setSelRemoteModeCfgClient:
			[coder decodeObjectForKey:@"selRemoteModeCfgClient"]];
	[self setSelModeCfgPullEnable:
			[coder decodeObjectForKey:@"selModeCfgPullEnable"]];
	...
	[self setSelPlutoStdErrLog:
			[coder decodeObjectForKey:@"selPlutoStdErrLog"]];
	[self setSelPlutoRestartOnCrash:
			[coder decodeObjectForKey:@"selPlutoRestartOnCrash"]];
