...
// Connection Options
@property (readwrite, retain) NSMutableString *selAuto, *selType, *selMode,
	*selLocalHost, *selLocalID, *selLocalSubnets, *selLocalProtocolPort,
	*selRemoteHost, *selRemoteID, *selRemoteSubnets, *selRemoteProtocolPort;
// Auth Options
@property (readwrite, retain) NSMutableString *selAuthBy, *selPSK, *selPKCS,
	*selSendCert, *selLocalRSASigKey, *selRemoteRSASigKey;
// Global Options
@property (readwrite, retain) NSMutableString *selVirtualPrivate,
	*selForceKeepAlive, *selKeepAlive, *selCrlCheckIntvl, *selMyID,
	*selPlutoDebug;

@property (readwrite, retain) NSButton *selForceEncaps, *selNatTEnable,
	*selStrictCrlEnable, *selOppEncEnable, *selUniqueIDs;

// Advanced Options
@property (readwrite, retain) NSMutableString *selDPDDelay, *selDPDTimeout,
	*selDPDAction, *selIKE1Enc, *selIKE1Hash, *selIKE2Enc, *selIKE2Hash,
	*selIKEv2, *selIKELifetime, *selPhase2, *selPhase2Alg, *selSALifetime,
	*selRekeyMargin, *selRekeyFuzz, *selKeyingTries,
	*selRemoteXauthUsername, *selLocalXauthUsername, *selModeCfgDNS1,
	*selModeCfgDNS2, *selModeCfgWins1, *selModeCfgWins2, *selNHelpers,
	*selSyslog, *selPlutoOpts, *selPlutoStdErrLog, *selPlutoRestartOnCrash,
	*selNextHop, *selSourceIP, *selUpdownScript;

@property (readwrite, retain) NSButton *selDPDEnable, *selCompressEnable,
	*selPfsEnable, *selRekeyEnable, *selLocalXauthServer,
	...
	*selRemoteModeCfgClient, *selModeCfgPullEnable;
