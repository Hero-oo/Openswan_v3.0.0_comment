...
static struct ctl_table ipsec_table[] = {
	...
	{
		CTL_NAME(NET_IPSEC_DEBUG_AH).procname = "debug_ah",
		.data = &debug_ah,
		.maxlen = sizeof(int),
		.mode = 0644,
		.child = NULL,
	...
	{
		CTL_NAME(NET_IPSEC_DEBUG_ESP).procname = "debug_esp",
		.data = &debug_esp,
		.maxlen = sizeof(int),
		.mode = 0644,
		.child = NULL,
	...
	{
		CTL_NAME(NET_IPSEC_DEBUG_MAST).procname = "debug_mast",
		.data = &debug_mast,
		.maxlen = sizeof(int),
		.mode = 0644,
		.child = NULL,
	...
	{
		CTL_NAME(NET_IPSEC_DEBUG_TUNNEL).procname = "debug_tunnel",
		.data = &debug_tunnel,
		.maxlen = sizeof(int),
		.mode = 0644,
		.child = NULL,
	...
	{
		CTL_NAME(NET_IPSEC_DEBUG_XMIT).procname = "debug_xmit",
		.data = &debug_xmit,
		.maxlen = sizeof(int),
		.mode = 0644,
		.child = NULL,
	...
	{
		CTL_NAME(NET_IPSEC_DEBUG_EROUTE).procname = "debug_eroute",
		.data = &debug_eroute,
		.maxlen = sizeof(int),
		.mode = 0644,
		.child = NULL,
	...
	{
		CTL_NAME(NET_IPSEC_DEBUG_SPI).procname = "debug_spi",
		.data = &debug_spi,
		.maxlen = sizeof(int),
		.mode = 0644,
		.child = NULL,
	...
	{
		CTL_NAME(NET_IPSEC_DEBUG_RADIJ).procname = "debug_radij",
		.data = &debug_radij,
		.maxlen = sizeof(int),
		.mode = 0644,
		.child = NULL,
	...
	{
		CTL_NAME(NET_IPSEC_DEBUG_NETLINK).procname = "debug_netlink",
		.data = &debug_netlink,
		.maxlen = sizeof(int),
		.mode = 0644,
		.child = NULL,
	...
	{
		CTL_NAME(NET_IPSEC_DEBUG_XFORM).procname = "debug_xform",
		.data = &debug_xform,
		.maxlen = sizeof(int),
		.mode = 0644,
		.child = NULL,
	...
	{
		CTL_NAME(NET_IPSEC_DEBUG_RCV).procname = "debug_rcv",
		.data = &debug_rcv,
		.maxlen = sizeof(int),
		.mode = 0644,
		.child = NULL,
	...
	{
		CTL_NAME(NET_IPSEC_DEBUG_PFKEY).procname = "debug_pfkey",
		.data = &debug_pfkey,
		.maxlen = sizeof(int),
		.mode = 0644,
		.child = NULL,
	...
	{
		CTL_NAME(NET_IPSEC_DEBUG_VERBOSE).procname = "debug_verbose",
...
#else
	{ NET_IPSEC_DEBUG_AH, "debug_ah", &debug_ah, sizeof(int), 0644, NULL,
	  .proc_handler = &proc_dointvec },
	{ NET_IPSEC_DEBUG_ESP, "debug_esp", &debug_esp, sizeof(int), 0644, NULL,
	  .proc_handler = &proc_dointvec },
	{ NET_IPSEC_DEBUG_MAST, "debug_mast", &debug_mast, sizeof(int), 0644,
	  NULL, .proc_handler = &proc_dointvec },
	{ NET_IPSEC_DEBUG_TUNNEL, "debug_tunnel", &debug_tunnel, sizeof(int),
	  0644, NULL, .proc_handler = &proc_dointvec },
	{ NET_IPSEC_DEBUG_TUNNEL, "debug_xmit", &debug_xmit, sizeof(int), 0644,
	  NULL, .proc_handler = &proc_dointvec },
	{ NET_IPSEC_DEBUG_EROUTE, "debug_eroute", &debug_eroute, sizeof(int),
	  0644, NULL, .proc_handler = &proc_dointvec },
	{ NET_IPSEC_DEBUG_SPI, "debug_spi", &debug_spi, sizeof(int), 0644, NULL,
	  .proc_handler = &proc_dointvec },
	{ NET_IPSEC_DEBUG_RADIJ, "debug_radij", &debug_radij, sizeof(int), 0644,
	  NULL, .proc_handler = &proc_dointvec },
	{ NET_IPSEC_DEBUG_NETLINK, "debug_netlink", &debug_netlink, sizeof(int),
	  0644, NULL, .proc_handler = &proc_dointvec },
	{ NET_IPSEC_DEBUG_XFORM, "debug_xform", &debug_xform, sizeof(int), 0644,
	  NULL, .proc_handler = &proc_dointvec },
	{ NET_IPSEC_DEBUG_RCV, "debug_rcv", &debug_rcv, sizeof(int), 0644, NULL,
	  .proc_handler = &proc_dointvec },
	{ NET_IPSEC_DEBUG_PFKEY, "debug_pfkey", &debug_pfkey, sizeof(int), 0644,
	  NULL, .proc_handler = &proc_dointvec },
...
#ifdef CTL_TABLE_PARENT
	{
		CTL_NAME(NET_IPSEC_DEBUG_IPCOMP).procname = "debug_ipcomp",
...
#ifdef CTL_TABLE_PARENT
	{
		CTL_NAME(NET_IPSEC_REGRESS_PFKEY_LOSSAGE).procname =
			"pfkey_lossage",
	...
	{ NET_IPSEC_REGRESS_PFKEY_LOSSAGE, "pfkey_lossage",
	  &sysctl_ipsec_regress_pfkey_lossage, sizeof(int), 0644, NULL,
	  .proc_handler = &proc_dointvec },
#endif /* CTL_TABLE_PARENT */
...
#ifdef CTL_TABLE_PARENT
	{
		CTL_NAME(NET_IPSEC_ICMP).procname = "icmp",
	...
	{
		CTL_NAME(NET_IPSEC_INBOUND_POLICY_CHECK).procname =
			"inbound_policy_check",
	...
	{
		CTL_NAME(NET_IPSEC_TOS).procname = "tos",
	...
	{ 0 }
#else
	{ NET_IPSEC_ICMP, "icmp", &sysctl_ipsec_icmp, sizeof(int), 0644, NULL,
	  .proc_handler = &proc_dointvec },
	{ NET_IPSEC_INBOUND_POLICY_CHECK, "inbound_policy_check",
	  &sysctl_ipsec_inbound_policy_check, sizeof(int), 0644, NULL,
	  .proc_handler = &proc_dointvec },
	{ NET_IPSEC_TOS, "tos", &sysctl_ipsec_tos, sizeof(int), 0644, NULL,
	  .proc_handler = &proc_dointvec },
	{ 0 }
#endif
};
...
#ifdef CTL_TABLE_PARENT
	{
		CTL_NAME(NET_IPSEC).procname = "ipsec",
		.data = NULL,
		.maxlen = 0,
		.mode = 0555,
		.child = ipsec_table,
